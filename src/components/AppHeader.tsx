...
export default function AppHeader({
  ...
  return (
    ...
    >
      ...
      {onTabChange && (
        <nav className="flex items-center gap-1.5 p-1 rounded-lg bg-[#050a20] border border-[var(--border)] font-mono text-xs shadow-inner">
          <button
          ...
          >
            <span className="w-2 h-2 rounded-full bg-[var(--accent-blue-bright)]" />
